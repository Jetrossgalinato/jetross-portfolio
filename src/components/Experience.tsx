  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto ">
        ...
        {/* Experience Timeline */}
        <div className="relative border border-md border-black dark:border-white p-6 rounded-lg">
          {/* Experience Items */}
          <div className="space-y-8">
            {currentExperience.map((experience, index) => (
              ...
              >
                {/* Company Logo/Avatar */}
                <div className="relative z-10 flex items-center justify-center w-12 h-12 bg-gray-200 dark:bg-white rounded-full flex-shrink-0 overflow-hidden">
                  <img
                    src={experience.logo}
